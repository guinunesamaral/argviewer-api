insert into tag (id, titulo, descricao)
values
(1, 'Meio Ambiente', 'Discussões gerais sobre meio ambiente.'),
(2, 'Religião', 'Discussões teológicas sobre a existência de Deus e sobre as diferentes religiões existentes.'),
